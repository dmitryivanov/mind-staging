...
class ActiveRecord::RdsDb
  mattr_accessor :shared_rds_connection
  @@shared_rds_connection = nil
 
  def self.connection
    @@shared_rds_connection || retrieve_connection
  end
end
 
# Forces all threads to share the same connection. This works on
# Capybara because it starts the web server in a thread.
ActiveRecord::RdsDb.shared_rds_connection = ActiveRecord::RdsDb.connection
